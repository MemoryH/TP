<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\daima\twothink\public/../application/admin/view/default/property\index.html";i:1521701843;s:75:"D:\daima\twothink\public/../application/admin/view/default/public\base.html";i:1521683245;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
	...
	<table class="">
		...
		<tr>
			...
			<td><?php if($vo['status'] == '1'): ?>
				<a href="<?php echo url('Property/changeStatus?method=forbidUser&id='.$vo['id']); ?>" class="ajax-get">待处理</a>
				<?php else: ?>
				<a href="<?php echo url('Property/changeStatus?method=resumeUser&id='.$vo['id']); ?>" class="ajax-get">已处理</a>
				<?php endif; ?>
				<a href="<?php echo url('Property/edit?id='.$vo['id']); ?>" class="authorize">编辑</a>
				<a href="<?php echo url('Property/changeStatus?method=deleteUser&id='.$vo['id']); ?>" class="confirm ajax-get">删除</a>
			</td>
		</tr>
