<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\daima\twothink\public/../application/home/view/default/index\index.html";i:1521789722;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/static/static/static/image/index.png" width="100%" />
        </div>
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Index/Property'); ?>">
