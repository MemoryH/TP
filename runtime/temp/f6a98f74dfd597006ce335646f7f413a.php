<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\daima\twothink\public/../application/admin/view/default/property\add.html";i:1521805916;s:75:"D:\daima\twothink\public/../application/admin/view/default/public\base.html";i:1521683245;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal" enctype="application/x-www-form-urlencoded">
        <div class="form-item">
            <label class="item-label">业主姓名<span class="check-tips">（用户名会作为确认信息使用）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="name" value="<?php echo $data['name']; ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">电话<span class="check-tips">（电话号码请注意填写正确）</span></label>
            <div class="controls">
                <input type="number" class="text input-large" name="tel" value="<?php echo $data['tel']; ?>">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <textarea name="content" id="" cols="30" class="input-large" rows="10"><?php echo $data['content']; ?></textarea>
            </div>
        </div>
