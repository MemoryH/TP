<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\daima\twothink\public/../application/admin/view/default/notice\add.html";i:1521944172;s:75:"D:\daima\twothink\public/../application/admin/view/default/public\base.html";i:1521683245;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<script src="/static/webuploader/webuploader.js"></script>
    ...
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal">
        ...
        <div id="uploader-demo">
            ...
            <img id='img_logo' src="<?php echo $data['img']; ?>">
            <input type="hidden" class="text input-large" id="img" name="img" value="<?php echo $data['img']; ?>">
        </div>
    ...
    <script type="text/javascript">
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: '<?php echo url('Notice/logo'); ?>',
