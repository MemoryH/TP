<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\daima\twothink\public/../application/admin/view/default/notice\index.html";i:1521874852;s:75:"D:\daima\twothink\public/../application/admin/view/default/public\base.html";i:1521683245;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
	<table class="">
		...
		<tr>
			...
			<td>
				<a href="<?php echo url('Notice/edit?id='.$vo['id']); ?>" class="authorize">编辑</a>
				<a href="<?php echo url('Notice/changeStatus?method=deleteUser&id='.$vo['id']); ?>" class="confirm ajax-get">删除</a>
			</td>
		</tr>
